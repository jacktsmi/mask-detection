...
therm1 = ax.imshow(np.zeros(mlx_interp_shape),cmap = plt.cm.bwr,vmin=25,vmax=45) #start plot with zeros
...
#         intimg = np.asarray(intimg)
        ...
        fig.savefig('hat_without_mask.png',dpi=300,facecolor='#FCFCFC',
